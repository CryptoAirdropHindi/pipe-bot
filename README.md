...
- **nano account.json** it save your account info like email and password
- **nano proxy.txt** to store proxy you want to use, each line for 1 proxy `http://username:pass@ip:port`
